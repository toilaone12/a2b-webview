...
const Login = () => {
  return (
    <View style={[styles.flexFull, styles.bgBlack, styles.px20, styles.pt50, styles.relative]}>
      {/* logo */}
      <ResponsiveImage source={logo} style={styles.logoPrimary} resizeMode="stretch" />

      {/* text */}
      <Text style={[styles.fs22, styles.lh32, styles.textWhite, styles.textCenter, styles.pt50]}>
